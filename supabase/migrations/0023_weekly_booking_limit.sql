-- ============================================================================
-- 0023_weekly_booking_limit.sql
-- book_session() (0005, reshaped by 0006/0007/0010/0014) checked active
-- membership, credit-pack balance, and capacity — but never
-- membership_plans.sessions_per_week, which has existed since 0001 and
-- was never actually enforced anywhere. A member on a "2x per week"
-- plan could book as many sessions as they liked. Full function body
-- copied forward from 0014 (never edit a past migration in place) with
-- one addition: if the active plan sets sessions_per_week, count this
-- member's booked sessions in the SAME Mon-Sun week as the session
-- being booked, and reject once that plan's weekly allowance is used.
-- ============================================================================
