-- ============================================================================
-- 0031_two_week_booking_window.sql
-- Members could book any future session, however far ahead. Owner's call
-- (2026-09-25): bookings open two weeks ahead. Full function body copied
-- forward from 0030 (never edit a past migration in place) with one
-- addition: reject sessions dated more than 14 days after today (UK).
-- Run AFTER 0030.
-- ============================================================================
